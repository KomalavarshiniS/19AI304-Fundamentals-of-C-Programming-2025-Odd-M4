...
void validateDate() {
    ...
    if ((mm == 1 || mm == 3 || mm == 5 || mm == 7 || mm == 8 || mm == 10 || mm == 12) && dd >=1 && dd <=31)
        ...
        if ((leap && dd >=1 && dd <=29) || (!leap && dd >=1 && dd <=28))
            printf("Date is valid.\n");
        else
...
```
# Output:
<img width="336" height="207" alt="image" src="https://github.com/user-attachments/assets/7d8d12f9-212b-48a1-baef-34d3347982a6" />
...
```
# Output:
<img width="379" height="268" alt="image" src="https://github.com/user-attachments/assets/e1307307-2056-4737-b9fb-8b1770676a1f" />
...
```
# Output:
<img width="602" height="255" alt="image" src="https://github.com/user-attachments/assets/ee5e0eb8-3595-4760-a8aa-cba36e985623" />
...
```
# Output:
<img width="588" height="104" alt="image" src="https://github.com/user-attachments/assets/04d3f243-69cc-4027-8917-f0c151fa7743" />
...
void convertFirstCLastC(char str[]) {
    ...
    if(len > 1) str[len-1] = toupper(str[len-1]);
}
...
```
# Output:
<img width="535" height="199" alt="image" src="https://github.com/user-attachments/assets/ff72b88e-d8c0-489e-a7a8-be38c97aa94b" />
